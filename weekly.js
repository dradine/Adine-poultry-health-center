...
/* =========================================================
   ...
   Persian / Arabic / English Numbers
   Shamsi Date - NO external date library required
   Supabase
   Editing Records
   Uniformity ±10% / ±15%
   ========================================================= */
...
function attachNumberInputHandler(input) {
    ...
    input.dataset.numberPrepared = "true";
...
function editWeeklyRecord(recordId) {
...
function formatDateDisplay(date) {
     ...
     */
    if (
        /^[\d۰-۹٠-٩]{4}\/[\d۰-۹٠-٩]{1,2}\/[\d۰-۹٠-٩]{1,2}$/
            .test(text)
    ) {
...
function gregorianDateToJalali(date) {
